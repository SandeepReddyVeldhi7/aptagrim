...
import { Candidate, JobDetailsProps } from "../types";

export const JobCard = ({ job }: JobDetailsProps) => {
    ...
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 flex flex-col">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 min-w-0">
          <input type="checkbox" className="accent-purple-600 cursor-pointer" />
            ...
            <div key={crypto.randomUUID()}>
              ...
              <div className="grid grid-cols-4 gap-1 mt-4 text-center">
                {[
                  ...
                  <div
                    key={i}
                    className={`flex flex-col items-center px-1 ${i > 0 ? "border-l border-gray-300" : ""}`}
                  >
